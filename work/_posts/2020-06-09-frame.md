...
```
cd ~
wget https://raw.githubusercontent.com/mearlboro/fehFrame/master/slideshow_start.sh
chmod +x slideshow_start.sh
```
...
```
wget https://raw.githubusercontent.com/mearlboro/fehFrame/master/slideshow_sync.sh
