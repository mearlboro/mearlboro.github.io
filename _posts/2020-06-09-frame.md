...
layout: post
title: "fehFrame"
description: We used an old screen and a Raspberry Pi to make a digital picture frame.
...
The fehFrame is an open-source digital picture frame. Many such projects exist but as far as I have looked this is the simplest. There are many alternatives and extra functionalities one can achieve, but they seemed to be quite complicated and/or use a lot of unnecessary code.

This takes less than an hour to setup and only uses Linux utilities. **No programming required**, just running some commands.
...
Continue reading for the full saga of errors and troubleshooting steps or feel free to skip stright to the [Instructions](#instructions).
...
All software used for this project is open source and should be available in any package manager, if not already installed on your Raspbian.
...
4. Add some images to the folder, or use [the rclone instructions](https://rclone.org/docs/) for your preferred remote file storage.
